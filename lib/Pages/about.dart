              ...
              children: [
                ListTile(
                  ...
                  title: Text(
                      ...
                      'Januar Rio Grace Sitorus'),
                  subtitle: Text(
                      'Instagram : @jiiooo_reef\nWhatsapp : +6282286844622'),
                ),
                SizedBox(
                  height: 10,
                ),
                ...
                ListTile(
                  leading: Image(
                      ...
                      fit: BoxFit.fill),
                  title:
                      Text(style: TextStyle(fontSize: 18), 'Febriadi Lesmana'),
                  subtitle:
                      Text('Instagram : @w.p3bz_\nWhatsapp : +6285375793833'),
                ),
                SizedBox(
                  height: 10,
                ),
